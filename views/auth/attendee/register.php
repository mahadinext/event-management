...
<head>
    ...
    <title>Registration - Attendee Dashboard</title>
...
<body>
    ...
    <div class="login-container">
        <form method="POST" action="/attendee/register" class="login-form" id="registerForm">
            <h2>Register</h2>
            ...
            <div class="links">
                <a href="/attendee/login">Already have an account? Login</a>
            </div>
        </form>
    </div>
